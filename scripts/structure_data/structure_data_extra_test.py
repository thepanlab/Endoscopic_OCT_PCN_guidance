...
def get_ordered_list_files_and_labels(config_json):
    ...
    # get list of labels
    l_path_labeled_files = glob.glob(f'{data_directory}/*-labeled_1ch.png', recursive=True)
