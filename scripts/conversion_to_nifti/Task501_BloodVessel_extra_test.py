...
if __name__ == '__main__':
    ...
    # base = '/home/pcallec/nnUNet_blood-vessel/data/5000_new_structure'
    # base = '/home/pcallec/nnUNet_blood-vessel/data/5000_v2_new_structure'
    base = '/home/pcallec/nnUNet_blood-vessel/data/100_extra_test_new_structure'
    # this folder should have the training and testing subfolders

    # now start the conversion to nnU-Net:
    task_name = 'Task501_BloodVessel'
    ...
    for t in training_cases:
        ...
        # the labels are stored as 0: background, 91: bloodvessel. We need to convert the 91 to 1 because nnU-Net expects
        # the labels to be consecutive integers. This can be achieved with setting a transform
        convert_2d_image_to_nifti(input_segmentation_file, output_seg_file, is_seg=True,
                                  transform=lambda x: (x == 91).astype(int))
    ...
    #     convert_2d_image_to_nifti(input_image_file, output_image_file, is_seg=False)
    #     # 91 is the pixel value for the blood vessel in the grayscale images
    #     convert_2d_image_to_nifti(input_segmentation_file, output_seg_file, is_seg=True,
    #                               transform=lambda x: (x == 91).astype(int))

    # # finally we can call the utility for generating a dataset.json
    generate_dataset_json(join(target_base, 'dataset.json'), target_imagesTr, imagesTs_dir=None, modalities=('Red', 'Green', 'Blue'),
                          labels={0: 'background', 1: 'blood-vessel'}, dataset_name=task_name, license='hands off!')
